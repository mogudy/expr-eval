...
describe('Functions', function () {
    ...
    describe('substr(str,a,b)', function () {
        it('should return substr of str(a,b)!', function () {
            var parser = new Parser();
            assert.strictEqual(parser.evaluate('substr("abc",1)'), 'bc');
        });
    });

    describe('now(format)', function () {
        it('should return current date as given format', function () {
            var parser = new Parser();
